              ...
              >
                {doubledSkills.map((skill, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className="flex items-center gap-2.5 px-4 py-2 bg-gray-900/40 backdrop-blur-sm border border-gray-700/50 rounded-full hover:border-blue-400/50 transition-all duration-300 shrink-0"
                    >
                      <Icon className="w-5 h-5 md:w-6 md:h-6 transition-transform duration-300 hover:scale-110" style={{ color: skill.color }} />
              ...
              >
                {doubledSoftSkills.map((skill, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className="flex items-center gap-2.5 px-4 py-2 bg-gray-900/40 backdrop-blur-sm border border-gray-700/50 rounded-full hover:border-purple-400/50 transition-all duration-300 shrink-0"
                    >
                      <Icon className="w-5 h-5 md:w-6 md:h-6 transition-transform duration-300 hover:scale-110" style={{ color: skill.color }} />
                      <span className="text-gray-300 text-sm font-medium">{skill.name}</span>
                    </div>
